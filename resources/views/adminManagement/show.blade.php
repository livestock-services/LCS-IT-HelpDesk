          ...
          <div class="col-lg-5 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
            <div class="info">
              ...
              @if($adminDetails->status == 0)              
                ...
                <a href="{{ route('adminManagement.activateAndDeactivateAdminAccount',['adminId'=>$adminDetails->id,'status'=>1])}}"><div class="phone">
                <p style="color: green;">Activate Account</p>
              </div></a>
              @else              
                <i class="bi bi-unlock-fill"></i>
                <h4 style="color: green;">Active Account</h4>
                <a href="{{ route('adminManagement.activateAndDeactivateAdminAccount',['adminId'=>$adminDetails->id,'status'=>0])}}"><div class="phone">
