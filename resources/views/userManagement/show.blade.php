          ...
          <div class="col-lg-5 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
            <div class="info">
              ...
              @if($userDetails->status == 0)              
                ...
                <h4 style="color: red;">Deactivated Account </h4>
                <a href="{{ route('userManagement.activateAndDeactivateUserAccount',['userId'=>$userDetails->id,'status'=>1])}}"><div class="phone">
                <p style="color: green;">Activate Account</p>
              </div></a>
              @else              
                <i class="bi bi-unlock-fill"></i>
                <h4 style="color: green;">Active Account</h4>
                <a href="{{ route('userManagement.activateAndDeactivateUserAccount',['userId'=>$userDetails->id,'status'=>0])}}"><div class="phone">
                <p style="color: red;">Deactivate Account</p>
              </div></a>
              @endif
          ...
          <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch " data-aos="fade-up" data-aos-delay="100" style="width: -webkit-fill-available;">
                ...
                <div class="container" data-aos="fade-up">
                    ...
                    @if(count($userQueries) > 0)
                      @foreach($userQueries as $userQuerie)
                    
                        <li>
                          <div data-bs-toggle="collapse" class="collapsed question" href="#faq1">{{$userQuerie->queryDetails}} <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
